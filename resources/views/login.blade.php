...
<head>
    ...
    <title>Lumio.Light</title>
    <meta name="description" content="Lumio.Light">
...
<body class="bg-dark">
    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h3 style="color: #fff">Lumio.Light</h3>
                </div>
        ...
        <script type="text/javascript" src="{!! asset('js/assets/js/vendor/jquery-2.1.4.min.j') !!}"></script>
        <script type="text/javascript" src="{!! asset('js/assets/js/popper.min.js') !!}"></script>
