        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <a href="{{ route('sale') }}"> <i class="menu-icon fa fa-shopping-cart"></i>Sale</a>
                    </li>

                    <li class="active">
                        <a href="{{ route('show_orders') }}"> <i class="menu-icon fa  fa-archive"></i>Orders</a>
                    </li>

                    <li class="active">
                        <a href="{{ route('show_returns') }}"> <i class="menu-icon fa fa-minus-circle"></i>Returns Status</a>
                    </li>
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-plus-square-o"></i>
                             ...
                             <li><i class="fa fa-search"></i>
                                <a href="{{ route('show_category') }}">Show Category</a>
                            </li>
                            ...
                            <li><i class="fa fa-search"></i>
                                <a href="{{ route('show_size') }}">Show Size</a>
                            </li>
                            <hr style="background: grey">

                            <li><i class="fa fa-plus-square-o"></i>
                                <a href="{{ route('add_color') }}">Add Color</a>
                            </li>

                            <li><i class="fa fa-search"></i>
                                <a href=" {{ route('show_color') }}">Show Color</a>
                            </li>
                            <hr style="background: grey">r

                            <li><i class="fa fa-plus-square-o"></i>
                                <a href="{{ route('add_material') }}">Add Material</a>
                            </li>
                            

                            <li><i class="fa fa-search"></i>
                                <a href="{{ route('show_material') }}">Show Material</a>
                            </li>
                    ...
                    @if(Auth::user()->isAdmin())
                     ...
                     <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus-square-o"></i><a href="{{ route('add_items') }}">Add Items</a></li>
                            <li><i class="fa fa-search"></i><a href="{{ route('show_items') }}">Show Items</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus-square-o"></i><a href="{{route('add_user')}}">Add Employees</a></li>
                            <li><i class="menu-icon fa fa-search"></i><a href="{{ route('show_users') }}">Show Employees</a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-search"></i><a href="{{ route('show_loans') }}">Show Loans</a></li>
                        </ul>
                    </li>

                   <li>
                        <a href="{{ route('date_picker') }}"> <i class="menu-icon fa  fa-calendar-o"></i>Reporting</a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('return_confirmation') }}"> <i class="menu-icon fa fa-check-square"></i>Returned Items</a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus-square-o"></i> <a href="{{ route('role') }}">Add Roles</a></li>
                        </ul>
                    </li>
