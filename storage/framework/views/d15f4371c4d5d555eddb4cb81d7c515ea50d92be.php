...
<head>
    ...
    <title>Ela - Bootstrap Admin Dashboard Template</title>
        ...
        <link href="<?php echo e(asset('css/css/lib/bootstrap/bootstrap.min.css')); ?>" rel="stylesheet">

        

        <link href="<?php echo e(asset('css/css/lib/calendar2/semantic.ui.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/css/lib/calendar2/pignose.calendar.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/css/lib/owl.carousel.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/css/lib/owl.theme.default.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/css/helper.css')); ?>" rel="stylesheet">
...
<body class="fix-header fix-sidebar">
    ...
    <script type="text/javascript" src="<?php echo asset('js/js/lib/jquery/jquery.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/bootstrap/js/popper.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/bootstrap/js/bootstrap.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/jquery.slimscroll.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/sidebarmenu.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/sticky-kit-master/dist/sticky-kit.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/morris-chart/raphael-min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/morris-chart/morris.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/morris-chart/dashboard1-init.js'); ?>"></script>

    <script type="text/javascript" src="<?php echo asset('js/js/lib/calendar-2/moment.latest.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/calendar-2/semantic.ui.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/calendar-2/prism.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/calendar-2/pignose.calendar.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/calendar-2/pignose.init.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/owl-carousel/owl.carousel.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/lib/owl-carousel/owl.carousel-init.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/scripts.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo asset('js/js/custom.min.js'); ?>"></script>
