        ...
        <div class="row" style="margin-top: 10px; background-color: #ffffff">
            ...
            <div class="col-lg-12">
                <div class="card">
                                        ...
                                        <div class="input-group add-on" style="width: 500px; margin-left: 50%">
                                            <select class="form-control" name="buyer">
                                                ...
                                                <?php $__currentLoopData = $buyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $buyer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($buyer->id); ?>"><?php echo e($buyer->place_name); ?></option>
                    ...
                    <?php if(session('$many_items') or count($many_items) > 0): ?>
                    <div class="card-body">
                        <table class="table table-bordered">
                          <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="5"><strong style="font-size: 15pt; float: right;">
                                  ...
                                  <span style="margin-right: 15px;">Total</span> $<?php echo e($baskets->pluck('total_price')->sum()); ?>
                            ...
                            <tr>
                                  <?php if($baskets->count() > 0): ?>
                                    <?php if($baskets->first()->payment_type == 0 && $basket->first()->buyer_id >0): ?>
                                      <td colspan="5">
                                        <p>sell to <?php echo e($baskets->first()->buyer->place_name); ?> as loan</p>
                                      </td>
                                    <?php endif; ?>
                                  <?php endif; ?>
                            </tr>
                    ...
                    <div class="panel-heading" style="padding: 10px; margin-bottom: 3px ;background-color: #26C281">
                        <h3 class="text-center">
                            <strong style="color: #fff">
                                    <a href="<?php echo e(route('order_confirm')); ?>" style="color: #fff">Confirm</a>
                            </strong>
                        </h3>
                    </div>
